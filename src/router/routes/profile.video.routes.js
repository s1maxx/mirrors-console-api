...
const profileVideoArrayGet = [
    ...
    {path:'/profiles/videos/:id', requiredRoles:[admin, mirror_owner], table:profile_videos, needAuth:true, function:profileVideoController.getProfilesVideos, description: "return profile video array by user ID"},
]
