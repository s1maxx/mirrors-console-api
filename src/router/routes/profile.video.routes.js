...
const profileVideoArrayGet = [
    ...
    {path:'/profiles/videos', requiredRoles:[admin], table:profile_videos, needAuth:true, function:profileVideoController.getProfilesVideos, description: "return profile video array by user ID"},
]
